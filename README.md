...
AIM Agent 是一个面向 [VEX AIM 编程机器人](https://api.vex.com/aim/index.html)的具身智能体框架。它使机器人能够感知环境、进行推理并做出自主决策——将 VEX AIM 从可编程机器人转变为能够进行自然交互的智能体。

通过将 VEX AIM WebSocket 库与大语言模型（通过阿里云百炼 / DashScope API）相结合，AIM Agent 打通了 AI 推理与物理机器人控制之间的桥梁。
...
- [ ] **自主决策** - 智能体感知环境、推理情况并自主决定行动，无需人工干预 
